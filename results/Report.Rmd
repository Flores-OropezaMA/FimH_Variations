...
database <- read.delim("./data/traits/database.txt", row.names=1, comment.char="#")
head(database)
```
...
```{r fig.height=750, fig.width=1200}
...
This data base was analyse using the Mesquite program, in this scenario a alignament with Clustal W and tree was performed.

![](images/tree.tif)

In red ther a is clear t
